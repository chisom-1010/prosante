...
const PRACTITIONERS = ['Pas de Préference', 'Dr. Martin', 'Dr. Dubois', 'Dr. Laurent'];
...
export default function AppointmentForm() {
  ...
  const validateForm = () => {
    ...
    if (!formData.practitioner) newErrors.practitioner = 'Practitioner is required';
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <ToggleGroup
                  ...
                  onValueChange={(value) => {
                    if (value) setFormData({ ...formData, selectedDate: value });
                  }}
                  ...
                  {AVAILABILITY_DATES.map((date) => (
                    ...
                    >
                      ...
                      <span className="block text-xs font-light">
                        {date.full === 'Sélectionné' ? 'Sélectionné' : date.full}
                      </span>
                    </ToggleGroupItem>
                  ))}
                </ToggleGroup>
        ...
        <Card className="bg-primary text-primary-foreground border-0">
          <CardHeader className="space-y-4">
            ...
            <p className="text-sm italic font-light">
              {HEALTH_ADVICE.content}
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-xs leading-relaxed">{HEALTH_ADVICE.description}</p>
            <p className="text-xs leading-relaxed">
              {HEALTH_ADVICE.urgency}
            </p>
          </CardContent>
        </Card>
